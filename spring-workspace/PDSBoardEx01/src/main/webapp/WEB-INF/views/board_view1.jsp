...
<%@ page import="com.exam.mvc.model.BoardTO" %>
...
<%
	...
	String file = "";
	if( filesize !=0 ) {
		//file = "<a href='./upload/" + filename + "'>" + filename + "</a>(" + filesize + "Kbyte)";
		//file = "<a href='./download.jsp?filename=" + filename + "'>" + filename + "</a>(" + filesize + "Kbyte)";
		file = "<a href='./download.do?filename=" + filename + "'>" + filename + "</a>(" + filesize + "Kbyte)";
	}
%>
