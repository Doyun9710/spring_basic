...
<%@ page import="com.exam.mvc.model.ZipcodeTO" %>
...
<%
	...
	//ArrayList<ZipcodeTO> datas = (ArrayList)request.getAttribute( "lists" );
	List<ZipcodeTO> datas = (List)request.getAttribute( "lists" );
