...
<script type="text/javascript">
	window.onload = function() {
		document.getElementById( 'dbtn' ).onclick = function() {
			if( document.dfrm.password.value.trim() == null ) {
				alert( '비밀번호 입력!' );
				return;
			}
	...
	<form action="./board_delete1_ok.jsp" method="post" name="dfrm">
		...
		<div class="contents_sub">	
			...
			<div class="board_write">
				...
				<tr>
					<th class="top">글쓴이</th>
					<td class="top"><input type="text" name="writer" value="<%= subject %>" class="board_view_input_mail" maxlength="5" readonly/></td>
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" name="subject" value="<%= writer %>" class="board_view_input" readonly/></td>
				</tr>
				<tr>
					<th>비밀번호</th>
